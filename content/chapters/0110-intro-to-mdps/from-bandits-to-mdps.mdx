...
<div className="my-6 flex justify-center">
  <div className="inline-block">
    <div style={{display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '2px'}}>
      <div className="w-12 h-12 bg-blue-600/40 border border-slate-600 rounded flex items-center justify-center text-lg">🤖</div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-slate-700/50 border border-slate-600 rounded flex items-center justify-center"></div><div className="w-12 h-12 bg-emerald-600/40 border border-slate-600 rounded flex items-center justify-center text-lg">🎯</div>
    </div>
  </div>
</div>
...
<div className="grid md:grid-cols-2 gap-6 my-6">
  <div className="p-4 bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-lg border border-slate-600">
    <h4 className="font-semibold text-slate-300 mb-3">🎰 Bandit Problems</h4>
    <ul className="text-slate-400 text-sm space-y-2">
      <li>Each decision is independent</li>
      <li>No concept of "state"</li>
      <li>Action → Reward, that's it</li>
  ...
  <div className="p-4 bg-gradient-to-br from-cyan-900/30 to-cyan-800/10 rounded-lg border border-cyan-700/50 ring-2 ring-cyan-500/20">
    <h4 className="font-semibold text-cyan-400 mb-3">🗺️ Sequential Decisions (MDPs)</h4>
    <ul className="text-slate-400 text-sm space-y-2">
      <li>Decisions affect future situations</li>
      <li>Current state determines options</li>
      <li>Action → Reward + New State</li>
...
| Problem | Bandit or MDP? | Why |
|---------|----------------|-----|
| Choosing which ad to show | Bandit | Each impression is independent |
| Playing a video game | **MDP** | Actions change the game state |
| A/B testing a webpage | Bandit | Users don't return (or we treat each visit independently) |
| Training a robot arm | **MDP** | Each movement changes position |
| Recommending a movie | It depends! | Single recommendation = bandit; session = MDP |
