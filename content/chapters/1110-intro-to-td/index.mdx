...
import TDLearningDemo from '@/components/interactive/TDLearningDemo';
...
<div className="grid md:grid-cols-3 gap-4 my-6">
  <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-xl p-4 border border-slate-600">
    <div className="text-slate-300 font-bold text-lg mb-3">Dynamic Programming</div>
    <div className="space-y-2 text-sm">
      <div className="flex items-center gap-2">
        <span className="text-red-400">✗</span>
        <span className="text-slate-400">Needs model</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="text-emerald-400">✓</span>
        <span className="text-slate-400">No complete episodes</span>
      </div>
      <div className="text-slate-500 text-xs mt-2">Updates after computing all states</div>
    </div>
  </div>
  <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/30 rounded-xl p-4 border border-slate-600">
    <div className="text-slate-300 font-bold text-lg mb-3">Monte Carlo</div>
    <div className="space-y-2 text-sm">
      <div className="flex items-center gap-2">
        <span className="text-emerald-400">✓</span>
        <span className="text-slate-400">Model-free</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="text-red-400">✗</span>
        <span className="text-slate-400">Needs complete episodes</span>
      </div>
      <div className="text-slate-500 text-xs mt-2">Updates at end of episode</div>
    </div>
  </div>
  <div className="bg-gradient-to-br from-cyan-900/30 to-cyan-800/10 rounded-xl p-4 border border-cyan-700/50 ring-2 ring-cyan-500/20">
    <div className="text-cyan-400 font-bold text-lg mb-3">TD Learning</div>
    <div className="space-y-2 text-sm">
      <div className="flex items-center gap-2">
        <span className="text-emerald-400">✓</span>
        <span className="text-slate-300">Model-free</span>
      </div>
      <div className="flex items-center gap-2">
        <span className="text-emerald-400">✓</span>
        <span className="text-slate-300">No complete episodes needed</span>
      </div>
      <div className="text-cyan-300 text-xs mt-2 font-medium">Updates every step!</div>
    </div>
  </div>
</div>
