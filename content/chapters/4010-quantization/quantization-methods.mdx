...
<div className="grid md:grid-cols-2 gap-4 my-8">
  <div className="bg-gradient-to-br from-cyan-900/30 to-cyan-800/10 rounded-xl p-6 border border-cyan-700/50">
    ...
    <div className="space-y-2 text-sm">
      <div className="flex items-center gap-2"><span className="text-emerald-400">✓</span> Fast—no retraining</div>
      <div className="flex items-center gap-2"><span className="text-emerald-400">✓</span> Works for huge models</div>
  ...
  <div className="bg-gradient-to-br from-violet-900/30 to-violet-800/10 rounded-xl p-6 border border-violet-700/50">
    ...
    <div className="space-y-2 text-sm">
      <div className="flex items-center gap-2"><span className="text-emerald-400">✓</span> Best accuracy</div>
      <div className="flex items-center gap-2"><span className="text-emerald-400">✓</span> Works for extreme quantization</div>
      <div className="flex items-center gap-2"><span className="text-red-400">✗</span> Requires training compute</div>
    </div>
  </div>
</div>
...
<div className="grid md:grid-cols-2 gap-4 my-6">
  <div className="bg-slate-800/50 rounded-lg p-5 border border-slate-700">
    ...
    <div className="text-xs space-y-1 text-slate-500">
      <div>• Run sample data to find ranges</div>
      <div>• Scales fixed at inference time</div>
  ...
  <div className="bg-slate-800/50 rounded-lg p-5 border border-slate-700">
    ...
    <div className="text-xs space-y-1 text-slate-500">
      <div>• No calibration needed</div>
      <div>• Adapts to each input</div>
...
<div className="my-8 p-6 bg-slate-800/30 rounded-xl border border-slate-700">
  ...
  <div className="grid md:grid-cols-2 gap-6">
    ...
    <div className="text-center">
      ...
      <div className="bg-slate-700/50 rounded-lg p-3 font-mono text-sm">
        <div className="text-slate-400">∂L/∂x = ∂L/∂y</div>
      </div>
...
<div className="my-8 p-6 bg-slate-800/30 rounded-xl border border-slate-700">
  ...
  <div className="flex items-center justify-center gap-3 flex-wrap">
    <div className="text-center">
      <div className="w-12 h-12 rounded-lg bg-amber-500/30 border border-amber-500/50 flex items-center justify-center font-mono text-sm">w₁</div>
      <div className="text-xs text-slate-500 mt-1">Quantize</div>
    </div>
    <div className="text-slate-500">→</div>
    <div className="text-center">
      <div className="flex gap-1">
        <div className="w-12 h-12 rounded-lg bg-slate-700/50 border border-slate-600 flex items-center justify-center font-mono text-sm">w₂</div>
        <div className="w-12 h-12 rounded-lg bg-slate-700/50 border border-slate-600 flex items-center justify-center font-mono text-sm">w₃</div>
  ...
  <div className="space-y-4 max-w-md mx-auto">
    <div className="flex items-center gap-3 p-3 bg-slate-700/30 rounded-lg">
      ...
      <div>
        ...
        <div className="text-slate-400 text-sm">→ Dynamic PTQ (one line of code)</div>
      </div>
    </div>
    ...
    <div className="flex items-center gap-3 p-3 bg-slate-700/30 rounded-lg">
      ...
      <div>
        ...
        <div className="text-slate-400 text-sm">→ GPTQ or AWQ (most common)</div>
      </div>
    </div>
    ...
    <div className="flex items-center gap-3 p-3 bg-slate-700/30 rounded-lg">
      ...
      <div>
        ...
        <div className="text-slate-400 text-sm">→ Try AWQ, then QAT if needed</div>
      </div>
    </div>
    ...
    <div className="flex items-center gap-3 p-3 bg-slate-700/30 rounded-lg">
      ...
      <div>
        ...
        <div className="text-slate-400 text-sm">→ QAT is your only option</div>
      </div>
    </div>
  </div>
</div>
...
<div className="my-6 overflow-x-auto">
  <div className="min-w-[600px]">
    <div className="grid grid-cols-5 gap-2 text-sm">
      <div className="bg-slate-800/50 p-3 rounded-lg font-bold text-slate-200">Method</div>
      <div className="bg-slate-800/50 p-3 rounded-lg font-bold text-slate-200">Speed</div>
      <div className="bg-slate-800/50 p-3 rounded-lg font-bold text-slate-200">Bits</div>
      <div className="bg-slate-800/50 p-3 rounded-lg font-bold text-slate-200">Accuracy</div>
      <div className="bg-slate-800/50 p-3 rounded-lg font-bold text-slate-200">Best For</div>

      <div className="bg-slate-900/30 p-3 rounded-lg text-slate-300">Dynamic PTQ</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-emerald-400">Fast</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">8</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">Good</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-slate-400">Quick start</div>

      <div className="bg-slate-900/30 p-3 rounded-lg text-slate-300">Static PTQ</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-emerald-400">Fast</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">8</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">Good</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-slate-400">Production</div>

      <div className="bg-slate-900/30 p-3 rounded-lg text-amber-400">GPTQ</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-amber-400">Medium</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">4</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">Great</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-slate-400">LLMs</div>

      <div className="bg-slate-900/30 p-3 rounded-lg text-emerald-400">AWQ</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-amber-400">Medium</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">4</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">Great</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-slate-400">LLMs</div>

      <div className="bg-slate-900/30 p-3 rounded-lg text-violet-400">QAT</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-red-400">Slow</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">2-8</div>
      <div className="bg-slate-900/30 p-3 rounded-lg">Best</div>
      <div className="bg-slate-900/30 p-3 rounded-lg text-slate-400">Extreme</div>
    </div>
  </div>
</div>
