...
<div className="grid md:grid-cols-3 gap-4 my-6">
  ...
  <div className="bg-gradient-to-br from-emerald-900/20 to-emerald-800/5 rounded-lg p-4 border border-emerald-700/40">
    ...
    <div className="text-xs text-emerald-400/70 mt-2">2× smaller</div>
  </div>
  <div className="bg-gradient-to-br from-amber-900/20 to-amber-800/5 rounded-lg p-4 border border-amber-700/40">
    ...
    <div className="text-xs text-amber-400/70 mt-2">4× smaller</div>
  </div>
</div>
...
<div className="my-6 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
  ...
  <div className="space-y-3">
    ...
    <div className="flex items-center gap-3">
      ...
      <span className="text-xs text-amber-400">2.0×</span>
    </div>
  </div>
...
<a href="/notebooks/quantize-llm.ipynb" className="inline-flex items-center gap-2 px-4 py-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white rounded-lg hover:from-cyan-500 hover:to-blue-500 transition-all">
  <span className="text-xl">📓</span>
  <div>
    <div className="font-semibold">Quantization Notebook</div>
    <div className="text-xs text-cyan-100">Load, quantize, evaluate, and deploy</div>
  </div>
</a>
