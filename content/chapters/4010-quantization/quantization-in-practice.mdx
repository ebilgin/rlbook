...
<div className="grid md:grid-cols-3 gap-4 my-6">
  ...
  <div className="bg-gradient-to-br from-emerald-900/20 to-emerald-800/5 rounded-lg p-4 border border-emerald-700/40">
    ...
    <div className="text-xs text-emerald-300 mt-2">2× smaller</div>
  </div>
  <div className="bg-gradient-to-br from-amber-900/20 to-amber-800/5 rounded-lg p-4 border border-amber-700/40">
    ...
    <div className="text-xs text-amber-300 mt-2">4× smaller</div>
  </div>
</div>
...
<div className="my-6 p-4 bg-slate-800/50 rounded-lg border border-slate-700">
  <div className="text-sm text-slate-400 mb-4">Typical Speedups (relative to float16 baseline)</div>
  <div className="space-y-4">
    <div className="flex items-center gap-3">
      <span className="text-xs text-slate-400 w-16 font-mono shrink-0">float16</span>
    ...
    <div className="flex items-center gap-3">
      <span className="text-xs text-slate-400 w-16 font-mono shrink-0">int8</span>
      <div className="flex-1">
    ...
    <div className="flex items-center gap-3">
      <span className="text-xs text-slate-400 w-16 font-mono shrink-0">int4</span>
      <div className="flex-1">
        <div style={{width: '100%', backgroundColor: '#f59e0b'}} className="h-6 rounded flex items-center justify-end pr-2">
          <span className="text-xs text-white font-semibold">2.0×</span>
        </div>
      </div>
    </div>
  </div>
  <div className="text-xs text-slate-500 text-center mt-4">Results vary by hardware and model</div>
</div>
...
<div className="grid md:grid-cols-2 gap-3 mt-3">
  <div className="flex items-center gap-2 text-sm text-slate-400">
    <span className="text-emerald-400">✓</span> Load Qwen-0.5B in fp16, 8-bit, 4-bit
  </div>
  <div className="flex items-center gap-2 text-sm text-slate-400">
    <span className="text-emerald-400">✓</span> Memory comparison
  </div>
  <div className="flex items-center gap-2 text-sm text-slate-400">
    <span className="text-emerald-400">✓</span> Perplexity evaluation
  </div>
  <div className="flex items-center gap-2 text-sm text-slate-400">
    <span className="text-emerald-400">✓</span> Speed benchmarks
  </div>
  <div className="flex items-center gap-2 text-sm text-slate-400">
    <span className="text-emerald-400">✓</span> GPTQ quantization
  </div>
  <div className="flex items-center gap-2 text-sm text-slate-400">
    <span className="text-emerald-400">✓</span> Runs on free Colab T4
  </div>
</div>
...
<div className="my-6 p-4 bg-slate-800/30 rounded-lg border border-slate-700">
  ...
  <div className="space-y-2 text-sm">
    <div className="flex items-start gap-2">
      ...
      <div><span className="text-slate-300">Need quick results?</span> <span className="text-cyan-400">→ bitsandbytes load_in_8bit</span></div>
    </div>
    <div className="flex items-start gap-2">
      <span className="text-slate-500">•</span>
      <div><span className="text-slate-300">Need best 4-bit quality?</span> <span className="text-amber-400">→ GPTQ with calibration</span></div>
    </div>
    <div className="flex items-start gap-2">
      <span className="text-slate-500">•</span>
      <div><span className="text-slate-300">PTQ not good enough?</span> <span className="text-violet-400">→ Try AWQ, then QAT</span></div>
    </div>
    <div className="flex items-start gap-2">
      <span className="text-slate-500">•</span>
      <div><span className="text-slate-300">RL policy?</span> <span className="text-emerald-400">→ `int8` policy, `fp16` value</span></div>
    </div>
  </div>
</div>
...
Continue to [Summary & Exercises](/chapters/quantization/summary-exercises).
